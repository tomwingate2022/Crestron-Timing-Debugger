...
echo.
echo Running: UI page changes (edges)
echo Filter: --only "page_name\$\|Popup"
py "%SCRIPT%" "%LOG%" --only "page_name\\$|Popup" --mode edges --max-signals 60
echo.
echo Done. Open the generated .edges.html file.
pause
